...
class TestConfigParser(unittest.TestCase):
    ...
    def test_ec2(self):
        ...
        known = {
         'AttachGateway': {'Properties': {'InternetGatewayId': {'Ref': 'InternetGateway'},
                                            'VpcId': {'Ref': 'VPC'}},
         ...
         'InternetGateway': {'Properties': {'Tags': [{'Key': 'Application',
         ...
         'PublicRoute': {'DependsOn': 'AttachGateway',
                          ...
                          'Type': 'AWS::EC2::Route'},
         'PublicRouteTable': {'Properties': {'Tags': [{'Key': 'Application',
                                                          'Value': {'Ref': 'AWS::StackId'}},
                                                         {'Key': 'Network',
                                                          'Value': 'Public'}],
                                               'VpcId': {'Ref': 'VPC'}},
         ...
         'SubnetA': {'Properties': {'AvailabilityZone': 'eu-west-1a',
                                      'CidrBlock': {'Fn::FindInMap': ['SubnetConfig',
                                                                        'VPC',
                                                                        'SubnetA']},
                                      ...
                                      'VpcId': {'Ref': 'VPC'}},
                      'Type': 'AWS::EC2::Subnet'},
         'SubnetB': {'Properties': {'AvailabilityZone': 'eu-west-1b',
                                      'CidrBlock': {'Fn::FindInMap': ['SubnetConfig',
                                                                        'VPC',
                                                                        'SubnetB']},
                                      'Tags': [{'Key': 'Application',
                                      ...
                                      'VpcId': {'Ref': 'VPC'}},
                      'Type': 'AWS::EC2::Subnet'},
         'SubnetC': {'Properties': {'AvailabilityZone': 'eu-west-1c',
                                      'CidrBlock': {'Fn::FindInMap': ['SubnetConfig',
                                                                        'VPC',
                                                                        'SubnetC']},
                                      'Tags': [{'Key': 'Application',
                                      ...
                                      'VpcId': {'Ref': 'VPC'}},
                      'Type': 'AWS::EC2::Subnet'},
         'SubnetRouteTableAssociationA': {'Properties': {'RouteTableId': {'Ref': 'PublicRouteTable'},
                                                           'SubnetId': {'Ref': 'SubnetA'}},
                                           'Type': 'AWS::EC2::SubnetRouteTableAssociation'},
         'SubnetRouteTableAssociationB': {'Properties': {'RouteTableId': {'Ref': 'PublicRouteTable'},
                                                           'SubnetId': {'Ref': 'SubnetB'}},
                                           'Type': 'AWS::EC2::SubnetRouteTableAssociation'},
         'SubnetRouteTableAssociationC': {'Properties': {'RouteTableId': {'Ref': 'PublicRouteTable'},
                                                           'SubnetId': {'Ref': 'SubnetC'}},
                                           'Type': 'AWS::EC2::SubnetRouteTableAssociation'},
         'VPC': {'Properties': {'CidrBlock': {'Fn::FindInMap': ['SubnetConfig',
                                                                    'VPC',
                                                                    'CIDR']},
